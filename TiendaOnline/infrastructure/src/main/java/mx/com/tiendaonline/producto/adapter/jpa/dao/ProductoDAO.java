...
@Repository
public class ProductoDAO implements mx.com.tiendaonline.cliente.port.dao.ClienteDAO {

   private final ClienteJpaAdapterRepository adapterRepository;
   private final ClienteDboMapper clienteDboMapper;

    public ProductoDAO(ClienteJpaAdapterRepository adapterRepository, ClienteDboMapper clienteDboMapper) {
